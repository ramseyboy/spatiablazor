...
internal static class PropertyExtensions
{
    ...
    {
        return typeof(T).GetProperty(propertyName)?.GetPropertyDisplayName() ?? string.Empty;
    }

    public static ValidationAttribute GetPropertyValidation<T>(this T _, string propertyName)
    {
